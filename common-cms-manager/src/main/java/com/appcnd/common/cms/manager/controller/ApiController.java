...
public class ApiController {
    ...
    @RequestMapping(value = "/savePreview", produces = "application/json;charset=UTF-8")
    public String savePreview(@RequestParam String uuid, @RequestBody JSONObject data) {
